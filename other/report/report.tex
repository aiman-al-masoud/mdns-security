...
The generated traffic has been analyzed and some studies have been conducted
...
\begin{figure}
    ...
    \qquad
    \subfloat[\centering The pinged device is the target. The attack has been performed by one attackers, 1 thread, rr any]{{\includegraphics[width=5.8cm]{./ping/ping-rtt2.png} }}%
