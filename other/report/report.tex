...
\Abstract{The aim of this report is discussing an implementation of a DoS attack, on a local area network (LAN), exploiting the mDNS protocol. 
...
There are some specific countermeasurements that can be applied to make the protocol more reliable and secure, and they can be considered as belonging in two mainly different categories:
\begin{itemize}[leftmargin=*]
