...
\Abstract{Add a brief discussion of the project}
...
The general format of RRs in mDNS is slightly different from classic DNS and is the Table \ref{tab:table2}.
...
\begin{table}[hbt]
	...
	\begin{tabular}{|C{1.7cm}|C{4.2cm}|C{1cm}|}
		...
		\hline
	\end{tabular}
	\caption{\label{tab:table2}Resource Records}
\end{table}
